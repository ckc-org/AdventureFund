<template>
  <div>
        ...
        <div class="mt-16">
          ...
          <div class="mt-5">
            <v-text-field
              ...
              type="number"
            />
            <div class="font-12 d-flex align-center black--text">
              <v-icon class="mr-1">mdi-credit-card-fast-outline</v-icon>
              using card ending with #2422
              <v-btn
                x-small
                class="ml-1 primary--text text--darken-1 text-none px-1 font-12"
                depressed
                text
                @click="show_payment_method_dialog = true"
              >
    ...
    <PaymentMethodDialog v-model="show_payment_method_dialog" @select_card="selected_card=$event"/>
  </div>
</template>
...
export default {
  ...
  data: () => ({
    ...
    show_payment_method_dialog: true,
  }),
  computed: {
    selected_amount() {
